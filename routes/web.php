...
use App\Http\Controllers\LoginController as userlogin;
...
// Route::get('/',[ManageProductController::class,'index']);
...
Route::get('/product-details/{id}', [PdDetailController::class, 'index']);
...
Route::get('/admin-index', [AdminIndexController::class, 'index'])->name('index')->middleware('admin');
...
Route::post('/admin-manage-product', [ManageProductController::class, 'store'])->name('manage_product.store');
Route::patch('/admin-manage-product/{id}', [ManageProductController::class, 'edit'])->name('manage_product_edit');
